...
memory4: coin-clp.o memory4.cc
	g++ -Wall -Icoin-Osi/include/coin -I/usr/local/mercury-11.07/lib/mercury/inc/ -Lcoin-Osi/lib -L/usr/local/mercury-11.07/lib/mercury/lib/ -lClp -lOsiClp -lOsi -lCoinUtils -lblas -lm -lpthread -lgc memory4.cc coin-clp.o -o memory4
